...
template <typename ItemType>      //added instead of "using ItemType = std::string;"
...
private:
    ...
    struct Node         //The Node class nested in the Set class can talk about the template parameter of the Set class
    {                   //it should not itself be a template class.
        ItemType m_value;
        Node* m_next;
        Node* m_prev;
    };
...
template <typename ItemType>            //added
...
template <typename ItemType>            //added
typename Set<ItemType>& Set<ItemType>::operator=(const Set& rhs)        //include "typename"
{
    if (this != &rhs)
    {
        // Copy and swap idiom
...
template <typename ItemType>            //added
typename Set<ItemType>::Node* Set<ItemType>::findFirstAtMost(const ItemType& value) const   //include "typename"
{
...
// change unite and difference to be function templates
